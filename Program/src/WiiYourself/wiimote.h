...
#endif
#define WIIYOURSELF_API __declspec(dllexport)
#ifdef WIIYOURSELF_EXPORT
//#define WIIYOURSELF_API __declspec(dllexport)
#else
//#define WIIYOURSELF_API __declspec(dllimport)
#ifdef _DEBUG
//#pragma comment(lib, "WiiYourself_debug.lib")
#else
//#pragma comment(lib, "WiiYourself.lib")
#endif
#endif

// exportÇ∑ÇÈÉNÉâÉXÇê›íË
struct WIIYOURSELF_API wiimote_state;
class WIIYOURSELF_API wiimote;
