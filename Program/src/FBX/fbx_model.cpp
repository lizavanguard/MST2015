...
p_toon_texture_(nullptr)
{
  ...
  anim_play_flg_ = false;  // アニメーション再生してるか否か
  anim_loop_flg_ = false;
  p_anim_flame_ = nullptr;  // アニメーションフレーム登録値　例１待機　０～１０フレーム　２歩き　１０～２０
  anim_count_ = 0;  // アニメーション数
  anim_add_count_ = 0.0f;  // アニメーション再生スピード
  anim_playing_num_ = 0;
